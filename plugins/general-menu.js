...
let handler = async (m, { conn, usedPrefix: _p }) => {
  try {
    ...
    //conn.sendHydrated(m.chat, text.trim(), conn.getName(conn.user.jid), await genProfile(conn, m), 'https://www.youtube.com/channel/UCzEdH_d_z82l9AI5JDghc0w', 'YouTube', null, null, [['Speedtest', _p + 'ping'], ['Owner', _p + 'owner']], m)
...
title: 'Simple Bot ZERO',
body: 'By VIMUKTHI',
thumbnail: fs.readFileSync("./thumbnail.jpg"),
sourceUrl: 'https://www.youtube.com/channel/UCzEdH_d_z82l9AI5JDghc0w'
  }
 } 
})
